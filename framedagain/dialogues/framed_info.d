...
CHAIN  
	IF ~~ THEN IDJINNI NO_JOURNAL_2
		@3002 /* ~For the murder of Skie Silvershield.  He killed her and trapped her soul inside a soultaker dagger.~ */
		== %IMOEN_JOINED% IF ~IsValidForPartyDialogue("IMOEN2")~ @3003 /* ~Oh how awful!~ */
	END
	++ @3004 /*~But what makes them think I did it.~ */ + NO_JOURNAL_3
...
CHAIN  
	IF ~~ THEN IDJINNI JOURNAL_2
		...
		== %IMOEN_JOINED% IF ~IsValidForPartyDialogue("IMOEN2")~ @3003 /* ~Oh how awful!~ */
	END
	++ @3004 /*~But what makes them think I did it.~ */ + JOURNAL_3


APPEND IDJINNI
	IF ~~ BEGIN NO_QUEST_FULL_INFO_NO_JOURNAL_1
		SAY @3000 /* ~It is unfortunate that I no longer am the keeper of the dagger the master used to frame you, or I would be able to offer it to you to sweeten the deal.~ */
		++ @3001 /* ~Frame me?  For what?~ */ + NO_JOURNAL_2
	END

	IF ~~ BEGIN NO_QUEST_FULL_INFO_JOURNAL_1
		SAY @3000 /* ~It is unfortunate that I no longer am the keeper of the dagger the master used to frame you, or I would be able to offer it to you to sweeten the deal.~ */
		++ @3001 /* ~Frame me?  For what?~ */ + JOURNAL_2
	END

	IF ~~ BEGIN LAVA_QUEST_FULL_INFO_NO_JOURNAL_1
		SAY @3007 /* ~To sweeten the deal, I will give you the dagger the master used to frame you.  I will have no use for it.~ */
		++ @3001 /* ~Frame me?  For what?~ */ + NO_JOURNAL_2
	END
	...
	IF ~~ BEGIN NO_QUEST_NO_INFO_NO_JOURNAL_1
		SAY @3000 /* ~It is unfortunate that I no longer am the keeper of the dagger the master used to frame you, or I would be able to offer it to you to sweeten the deal.~ */
		= @3006 /* ~But unfortunately, I suspect the dagger has been destroyed since he no longer had any use for it.~ */
		IF ~~ THEN EXIT
	END
	...
	IF ~~ BEGIN NO_JOURNAL_3
		SAY @3005 /* ~How he managed to cause others to believe you were the one who killed her, I do not know.~ */
	...
	IF ~~ BEGIN NO_QUEST_NO_JOURNAL_4
		SAY @3006 /* ~But unfortunately, I suspect the dagger has been destroyed since he no longer had any use for it.~ */
		IF ~~ THEN EXIT
	END

	IF ~~ BEGIN LAVA_QUEST_NO_JOURNAL_4
		SAY @3008 /* ~I am protecting the dagger for the master.  If you free me, I will you give it and your weapon.~ */
		IF ~~ THEN EXIT
	END
